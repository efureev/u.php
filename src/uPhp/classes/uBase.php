        ...
        if (is_bool($var)) {
            ...
            if (!empty($var)) {
                ...
                foreach ($var as $key => $value) {
                    ...
                    $value = explode('<br />', self::recursiveDumpHelper($value, $expLevel, $depth + 1, $done));
